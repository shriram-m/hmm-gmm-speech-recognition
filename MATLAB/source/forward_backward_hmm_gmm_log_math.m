function [mean_numerator, var_numerator, mean_var_denominator, wei_numerator, wei_denominator, aij_numerator, log_likelihood, likelihood] = forward_backward_hmm_gmm_log_math(mean, var, aij, weight, obs)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Taken from:
